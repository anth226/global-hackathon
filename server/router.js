...
module.exports = function (app) {
  ...
  authRoutes.post("/identity/email", upload.single("file"), AuthenticationController.sendEmailIdentity);
  ...
  userRoutes.get("/location/:location_id", requireAuth, UserController.listLocationParticipants)
  ...
  organizationRoutes.put("/", requireAuth, OrganizationController.updateOrganization);
  ...
  challengeRoutes.post("/support/:id", requireAuth, ChallengeController.supportChallenge);
  // Supported Challenges route
  challengeRoutes.get("/support/:org_id", ChallengeController.listSupportChallengeByOrg);
  ...
  challengeRoutes.get("/admin/pending", requireAuth, ChallengeController.adminPendingChallenges);
  // Admin approve pending challenge route
  challengeRoutes.post("/admin/approve/:challenge_id", requireAuth, ChallengeController.adminApproveChallenge);
  ...
  // List project route
  projectRoutes.post("/list/:count", requireAuth, ProjectController.listProject);
  // List review project route
  projectRoutes.post("/review-list/:count", ProjectController.listReviewProject);
  ...
  projectRoutes.get("/organization/:orgId", ProjectController.listProjectByOrgCreator)
  ...
  searchRoutes.get("/organization/:searchTxt", requireAuth, SearchController.orgSearch);
  // Get challenge search route
  searchRoutes.get("/challenge/:searchTxt", requireAuth, SearchController.challengeSearch);
  // Get participant search route
  searchRoutes.get("/participant/:searchTxt", requireAuth, SearchController.participantSearch);
  // Get project search route
  searchRoutes.get("/project/:searchTxt", requireAuth, SearchController.projectSearch);
  ...
  galleryRoutes.post("/public/:id", requireAuth,  GalleryController.publicGallery);
  // Admin project list route
  galleryRoutes.get("/admin/list", requireAuth, GalleryController.listAllGallery);
  ...
  notificationRoutes.post("/organization", requireAuth, upload.single("file"), NotificationController.notifyOrganizations);
  ...
  notificationRoutes.post("/location", requireAuth, NotificationController.notifyAllHostUsers);
  ...
  // Update user role
  adminRoutes.post("/judge/:id", requireAuth, AdminController.updateJudgeChallenge);
  // admin user route
  ...
  // send invite route
  orgMemberInvRoutes.post("/invite", requireAuth, OrgMemberInvController.createOrgInvite);
  // update invite route
  orgMemberInvRoutes.put("/update", requireAuth, OrgMemberInvController.updateOrgInvite);
  // resend invite route
  orgMemberInvRoutes.post("/resend", requireAuth, OrgMemberInvController.resendOrgInvite);
  // list judge route
  orgMemberInvRoutes.get("/:org_id", requireAuth, OrgMemberInvController.listOrgInvite);
  // delete invite route
  orgMemberInvRoutes.delete("/:id", requireAuth, OrgMemberInvController.deleteOrgInvite);
  ...
  locationRoutes.get("/admin", requireAuth, LocationController.adminListLocation);
