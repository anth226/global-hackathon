...
export default class VideoComponent extends Component {
  constructor(props) {
    ...
    this.state = {
      identity:
        null /* Will hold the fake name assigned to the client. The name is generated by faker on the server */,
  ...
  componentDidMount = async () => {
    let response = await axios.post(
      `${API_URL}/meeting/${this.props.id}/join`,
      {},
      {
  ...
  render() {
    ...
    */
    let joinOrLeaveRoomButton = this.state.hasJoinedRoom ? (
      ...
      <Button label="Join Room" onClick={this.joinRoom}>
        jOIN ROOM{" "}
      </Button>
    );
    return (
